...
void OkdResourcePtr<T>::unbind()
{
	if	( _pResource )
	{
		...
		{
			pResourceManager->removeResource<T>( _pResource->getResourceKey() );
		}
...
void OkdResourcePtr<T>::load()
{
	...
	if	( _pResource )
	{
		...
		OkdFileStream*			pResourceFileStream	= pResourceDatabase->openResourceFileStream( T::_eResourceType, _pResource->getResourceName(), OkdResourceDatabase::OpenStreamLoad );
...
void OkdResourcePtr<T>::save()
{
	...
	if	( _pResource )
	{
		...
		OkdResourceDatabase*	pResourceDatabase	= OrkidEngine::instance()->getResourceDatabase();
		OkdFileStream*			pResourceFileStream	= pResourceDatabase->openResourceFileStream( T::_eResourceType, _pResource->getResourceName(), OkdResourceDatabase::OpenStreamSave );
